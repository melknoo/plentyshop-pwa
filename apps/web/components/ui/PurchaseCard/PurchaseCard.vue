<template>
  <form
    ...
    class="text-white sms-border--pink p-4 xl:p-6 md:border md:border-neutral-100 md:shadow-lg md:rounded-md md:sticky md:top-40"
  ...
  >
    <div class="grid grid-cols-[2fr_1fr] mt-4">
      ...
      <div class="flex items-center justify-center">
        <WishlistButton
          ...
          class="sms-button--primary sms-purchasecard--whishlist_button"
          :class="{
            'bottom-0 right-0 mr-2 mb-2 bg-white ring-inset  !rounded-full':
    ...
    <div class="flex space-x-2">
      <Price class="sms-purchasecard--price" :price="priceWithProperties" :crossed-price="crossedPrice" />
    ...
    <div class="inline-flex items-center mt-4 mb-2">
      ...
      <UiButton
        ...
        class="ml-2 text-xs text-neutral-500 cursor-pointer sms-button--primary"
      ...
      <div class="flex flex-col md:flex-row flex-wrap gap-4">
        ...
        >
          <UiButton
            ...
            size="lg"
            class="w-full h-full sms-button--primary justify-center"
            :disabled="loading || !productGetters.isSalable(product)"
          >
            <template #prefix>
              <div v-if="!loading" class="flex row items-center justify-center">
