<template>
    <div class="sms-textimage--wrapper">
        <div class="sms-textimage--row relative overflow-hidden">
            ...
            <div class="sms-asset--straw-3 sms-textimage--straw" :style="{ backgroundImage: `url(${images?.img1_src})` }"/>
            <div class="sms-asset--straw-4 sms-textimage--straw" :style="{ backgroundImage: `url(${images?.img2_src})` }"/>
        </div>
    </div>
</template>
